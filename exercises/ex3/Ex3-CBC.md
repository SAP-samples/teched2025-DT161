...
>Note: The workspace is already available, and you have been assigned as a team member to start the implementation. Go to the available *xxx_**DDA_Scoping*** workspace by choosing **Settings** -> **Switch Workspace** and *Switch Workspace* in the Action column.
