...
>*Assign Deployment Target* activity has been already done for your workspace. You can check it and set it to *Completed*. In this step the connection between SAP Central Business Configuration workspace and S/4HANA tenant is done. 
...
8.	Ask [Joule for Consultants:](https://sapit-crossfunctions-prod-ragdoll.eu10.sapdas.cloud.sap/joule) *Why is it necessary to add a scope bundle in SAP Central Business Configuration?*
...
17.	Explore the scope of the non-standard country using *My Selected Scope*.
